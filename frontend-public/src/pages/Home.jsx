  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <div className="grid gap-3 md:grid-cols-5">
        <input className="border p-2 rounded" placeholder="Csity" value={city} onChange={e=>setCity(e.target.value)} />
       ...
       <button
  onClick={() =>
    nav(`/hotels?city=${encodeURIComponent(city)}&checkIn=${checkIn}&checkOut=${checkOut}&guests=${guests}`)
  }
